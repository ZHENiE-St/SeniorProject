...
<ul class="nav nav-pills nav-stacked">
  ...
  <li class="active"><a href= "work2">ข้อมูลงานซ่อม2</a></li>
        ...
        <tbody>
          ...
          <tr>
            <td valign="top" colspan="4" align="center">
              <input name="hidCType" type="hidden" id="hidCType" style="width: 1px;" size="1" value="A">
              <input name="hidCMFG" type="hidden" id="hidCMFG" style="width: 1px;" size="1" value="AHONDA">
              <input name="hidCModel" type="hidden" id="hidCModel" style="width: 1px;" size="2" value="Jazz 04 On">
              <input name="hidDSTYear" type="hidden" id="hidDSTYear" style="width: 1px;" size="1" value="2006-01-01">
              <input name="hidCVechTyp" type="hidden" id="hidCVechTyp" style="width: 1px;" size="1" value="5DR">
              <input name="hidEngsize" type="hidden" id="hidEngsize" style="width: 1px;" size="3" value="1500">
              ...
              <input name="hidHavePart" type="hidden" id="hidHavePart" style="width: 1px;" size="1" value="0">
              <input name="hidCProjref" type="hidden" id="hidCProjref" style="width: 1px;" size="1" value="HO404">
              <input name="hidDENDYear" type="hidden" id="hidDENDYear" style="width: 1px;" size="1" value="0">
              <input name="hidCTrimLevel" type="hidden" id="hidCTrimLevel" style="width: 1px;" size="1" value="GD37806 (i-DSI)">
          ...
          <tr bgcolor="#f3f3f4">
            ...
            <td class="stTd2">
              <input name="txtCarRegNo" type="text" value="กป1234กท" maxlength="50" id="txtCarRegNo" class="itemDtg" style="color:Black;width:144px;">&nbsp;
          ...
          <tr>
            <td colspan="4">
              <div style="display: none;" id="frame_select">
                <iframe id="frame1" height="100" src="" width="740" name="frame1" style="height: 150px;">
                </iframe>
              </div>
            </td>
          </tr>
